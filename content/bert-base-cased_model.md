---
title: "Bert-base-cased model"
slug: "bert-base-cased_model"
categories:
  - "Models"
...
[bert-base-cased](/index.php?title=Https://huggingface.co/bert-base-cased&action=edit&redlink=1)

**Name**

[bert-base-cased](/index.php?title=Bert-base-cased&action=edit&redlink=1)
...
Bert-base-cased model is a [Natural Language Processing](/wiki/natural_language_processing) [model](/wiki/model) used for [Fill-Mask](/index.php?title=Fill-Mask&action=edit&redlink=1).
...
#Be sure to have git-lfs installed (https://git-lfs.com)
git lfs install
git clone git@hf.co:bert-base-cased
...
async function query(data) {
	const response = await fetch(
		"https://api-inference.huggingface.co/models/bert-base-cased",
		{
...
curl https://api-inference.huggingface.co/models/bert-base-cased \
	-X POST \
