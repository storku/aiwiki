---
title: "Lengyue233/content-vec-best model"
slug: "lengyue233_content-vec-best_model"
categories:
  - "Models"
---Lengyue233/content-vec-best model

**Hugging Face**

[lengyue233/content-vec-best](/index.php?title=Https://huggingface.co/lengyue233/content-vec-best&action=edit&redlink=1)

**Name**

[content-vec-best](/index.php?title=Content-vec-best&action=edit&redlink=1)

**User / Organization**

[lengyue233](/index.php?title=Https://huggingface.co/lengyue233&action=edit&redlink=1)
...
[hubert](/index.php?title=Hubert&action=edit&redlink=1)

[lengyue233](/index.php?title=Lengyue233&action=edit&redlink=1)
[PyTorch](/index.php?title=PyTorch&action=edit&redlink=1), [Transformers](/wiki/transformers), [doi:10.57967/hf/0479](https://dx.doi.org/10.57967/hf/0479), [hubert](/index.php?title=Hubert&action=edit&redlink=1), [License: mit](/index.php?title=License:_mit&action=edit&redlink=1)

Lengyue233/content-vec-best model is a [Natural Language Processing](/wiki/natural_language_processing) [model](/wiki/model) used for .
...
#Be sure to have git-lfs installed (https://git-lfs.com)
git lfs install
git clone git@hf.co:lengyue233/content-vec-best
...
from transformers import AutoProcessor, HubertModelWithFinalProj

processor = AutoProcessor.from_pretrained("lengyue233/content-vec-best")
...
hub = {
	'HF_MODEL_ID':'lengyue233/content-vec-best',
...
role = sagemaker.get_execution_role()
hyperparameters = {
	'model_name_or_path':'lengyue233/content-vec-best',
