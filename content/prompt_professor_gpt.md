---
title: "Prompt Professor (GPT)"
slug: "prompt_professor_gpt"
categories:
  - "Agents"
  - "Custom_GPTs"
...
| **Description** | I know everything about Prompt Engineering. What do you want to know about prompt? |
| **Developer** | tempi.co.jp |
| **OpenAI URL** | [https://chat.openai.com//g/g-qfoOICq1l-prompt-professor](https://chat.openai.com//g/g-qfoOICq1l-prompt-professor) |
| **Chats** | 16,000 |
| **Knowledge** | Yes |
| **Free** | Yes |
| **Available** | Yes |
...
**Prompt Professor** is a [Custom GPT](/wiki/custom_gpt) for [ChatGPT](/wiki/chatgpt) in the [GPT Store](/wiki/gpt_store).                        
...
- Rate this prompt: ${prompt}

- Tell me 26 Principles of Good Prompt

## Knowledge (Uploaded Files)

- **[26_Principles_of_Good_Prompt.txt](/wiki/26_principles_of_good_prompt_txt)**
