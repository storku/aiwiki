...
| **Description** | Make a gif. Uses Dalle3 to make a spritesheet, then code interpreter to slice it and animate. Includes an automatic refinement and debug mode. v1.2 GPTavern |
| **Developer** | gptavern.mindgoblinstudios.com |
| **OpenAI URL** | [https://chat.openai.com//g/g-gbjSvXu6i-gif-pt](https://chat.openai.com//g/g-gbjSvXu6i-gif-pt) |
| **Chats** | 16,000 |
...
**Gif-PT** is a [Custom GPT](/wiki/custom_gpt) for [ChatGPT](/wiki/chatgpt) in the [GPT Store](/wiki/gpt_store).                        

## Instructions (System Prompt)

Use Dalle to draw images turning the user request into:
Sprite sheet. Contact sheet. Game asset. Item assets sprites. In-game sprites. Sprite Sheets.
...
ALL REQUESTS MUST BE TURNED INTO SHEET FOR SLICING. DO NOT DRAW A SINGLE CHARACTER. THEY DALLE IMG2TEXT MUST BE SPRITE SHEETS.
...
- Crystal geode contact sheet

- Pixel kitty dancing

- Tip: Upload image as a style seed
