...
| **OpenAI URL** | [https://chat.openai.com//g/g-EdqvwCQkF-dnd-gpt](https://chat.openai.com//g/g-EdqvwCQkF-dnd-gpt) |
| **Chats** | 6,000 |
| **Web Browsing** | Yes |
...
**DnD GPT** is a [Custom GPT](/wiki/custom_gpt) for [ChatGPT](/wiki/chatgpt) in the [GPT Store](/wiki/gpt_store).                        
...
- Always provide 5 potential actions the CHARACTER can take, fitting the THEME and CHARACTER's abilities per GAME rules. One should randomly be brilliant, ridiculous, or dangerous. Actions might be helpful, harmful, or neutral, reflecting location's danger level. Show each action as numbered list, framed by {} at text's end, for example 1. {like this}.
