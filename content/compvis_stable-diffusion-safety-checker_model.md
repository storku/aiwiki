---
title: "CompVis/stable-diffusion-safety-checker model"
slug: "compvis_stable-diffusion-safety-checker_model"
categories:
  - "Models"
---CompVis/stable-diffusion-safety-checker model

**Hugging Face**

[CompVis/stable-diffusion-safety-checker](/index.php?title=Https://huggingface.co/CompVis/stable-diffusion-safety-checker&action=edit&redlink=1)

**Name**

[stable-diffusion-safety-checker](/index.php?title=Stable-diffusion-safety-checker&action=edit&redlink=1)

**User / Organization**

[CompVis](/index.php?title=Https://huggingface.co/CompVis&action=edit&redlink=1)
...
[arxiv:2103.00020](https://www.arxiv.org/abs/2103.00020), [arxiv:1910.09700](https://www.arxiv.org/abs/1910.09700)

**Related to**

[clip](/index.php?title=Clip&action=edit&redlink=1)

[CompVis](/index.php?title=CompVis&action=edit&redlink=1)
[PyTorch](/index.php?title=PyTorch&action=edit&redlink=1), [Transformers](/wiki/transformers), [clip](/index.php?title=Clip&action=edit&redlink=1), [arxiv:2103.00020](https://www.arxiv.org/abs/2103.00020), [arxiv:1910.09700](https://www.arxiv.org/abs/1910.09700)

CompVis/stable-diffusion-safety-checker model is a [Computer Vision](/wiki/computer_vision) [model](/wiki/model) used for .
...
#Be sure to have git-lfs installed (https://git-lfs.com)
git lfs install
git clone git@hf.co:CompVis/stable-diffusion-safety-checker
...
hub = {
	'HF_MODEL_ID':'CompVis/stable-diffusion-safety-checker',
...
role = sagemaker.get_execution_role()
hyperparameters = {
	'model_name_or_path':'CompVis/stable-diffusion-safety-checker',
