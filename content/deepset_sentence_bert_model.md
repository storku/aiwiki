---
title: "Deepset/sentence bert model"
slug: "deepset_sentence_bert_model"
categories:
  - "Models"
---Deepset/sentence bert model

**Hugging Face**

[deepset/sentence_bert](/index.php?title=Https://huggingface.co/deepset/sentence_bert&action=edit&redlink=1)

**Name**

[sentence_bert](/index.php?title=Sentence_bert&action=edit&redlink=1)
...
[PyTorch](/index.php?title=PyTorch&action=edit&redlink=1), [JAX](/index.php?title=JAX&action=edit&redlink=1), [Transformers](/wiki/transformers), [bert](/wiki/bert), [License: apache-2.0](/index.php?title=License:_apache-2.0&action=edit&redlink=1)

Deepset/sentence bert model is a [Natural Language Processing](/wiki/natural_language_processing) [model](/wiki/model) used for .
...
#Be sure to have git-lfs installed (https://git-lfs.com)
git lfs install
git clone git@hf.co:deepset/sentence_bert
...
hub = {
	'HF_MODEL_ID':'deepset/sentence_bert',
