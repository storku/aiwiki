...
| **Description** | Body. Mind. Soul. |
| **Developer** | ELI L ROUSSO |
| **OpenAI URL** | [https://chat.openai.com//g/g-Lmt2TBepG-lifeos](https://chat.openai.com//g/g-Lmt2TBepG-lifeos) |
| **Chats** | 7,000 |
| **Web Browsing** | Yes |
...
**LifeOS** is a [Custom GPT](/wiki/custom_gpt) for [ChatGPT](/wiki/chatgpt) in the [GPT Store](/wiki/gpt_store).                        
...
- Help me find a way to be more mindful and present.

- Help me find a way to relieve stress.
