---
title: "Microsoft/resnet-50 model"
slug: "microsoft_resnet-50_model"
categories:
  - "Models"
...
[microsoft/resnet-50](/index.php?title=Https://huggingface.co/microsoft/resnet-50&action=edit&redlink=1)

**Name**

[resnet-50](/index.php?title=Resnet-50&action=edit&redlink=1)
...
Microsoft/resnet-50 model is a [Computer Vision](/wiki/computer_vision) [model](/wiki/model) used for [Image Classification](/index.php?title=Image_Classification&action=edit&redlink=1).
...
#Be sure to have git-lfs installed (https://git-lfs.com)
git lfs install
git clone git@hf.co:microsoft/resnet-50
...
gr.Interface.load("models/microsoft/resnet-50").launch()
