---
title: "10x Engineer (GPT)"
slug: "10x_engineer_gpt"
categories:
  - "Agents"
  - "Custom_GPTs"
---| 10x Engineer (GPT) |
...
| **Description** | a snarky code wizard that roasts and improves your programming |
| **Developer** | Jacob Ottiger |
| **OpenAI URL** | [https://chat.openai.com/g/g-nUwUAwUZm-10x-engineer](https://chat.openai.com/g/g-nUwUAwUZm-10x-engineer) |
| **Chats** | 5,000 |
| **Web Browsing** | Yes |
...
**10x Engineer** is a [Custom GPT](/wiki/custom_gpt) for [ChatGPT](/wiki/chatgpt) in the [GPT Store](/wiki/gpt_store).                        
