---
title: "Facebook/dino-vits8 model"
slug: "facebook_dino-vits8_model"
categories:
  - "Models"
---Facebook/dino-vits8 model

**Hugging Face**

[facebook/dino-vits8](/index.php?title=Https://huggingface.co/facebook/dino-vits8&action=edit&redlink=1)

**Name**

[dino-vits8](/index.php?title=Dino-vits8&action=edit&redlink=1)
...
git lfs install
git clone https://huggingface.co/facebook/dino-vits8
...
#Be sure to have git-lfs installed (https://git-lfs.com)
git lfs install
git clone git@hf.co:facebook/dino-vits8
...
API_URL = "https://api-inference.huggingface.co/models/facebook/dino-vits8"
...
async function query(data) {
	const response = await fetch(
		"https://api-inference.huggingface.co/models/facebook/dino-vits8",
		{
...
curl https://api-inference.huggingface.co/models/facebook/dino-vits8 \
	-X POST \
...
hub = {
	'HF_MODEL_ID':'facebook/dino-vits8',
...
gr.Interface.load("models/facebook/dino-vits8").launch()
...
role = sagemaker.get_execution_role()
hyperparameters = {
	'model_name_or_path':'facebook/dino-vits8',
