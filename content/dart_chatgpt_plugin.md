---
title: "Dart (ChatGPT Plugin)"
slug: "dart_chatgpt_plugin"
categories:
  - "Plugin"
---| Dart (ChatGPT Plugin) |
| --- |
...
| **Category** | [Project Management](/index.php?title=Project_Management&action=edit&redlink=1) |
| **Description** | Project management on autopilot. |
| **Release Date** | June 4, 2023 |
| **Available** | Yes |
| **Working** | Yes |

**Dart** is a [Plugin](/wiki/plugin) for [ChatGPT](/wiki/chatgpt).              
