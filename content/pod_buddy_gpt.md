...
| **Developer** | dgb.lol |
| **OpenAI URL** | [https://chat.openai.com/g/g-xGT2QvWZv-pod-buddy](https://chat.openai.com/g/g-xGT2QvWZv-pod-buddy) |
| **Chats** | 10,000 |
| **Knowledge** | Yes |
| **Web Browsing** | Yes |
...
**POD Buddy** is a [Custom GPT](/wiki/custom_gpt) for [ChatGPT](/wiki/chatgpt) in the [GPT Store](/wiki/gpt_store).                        
