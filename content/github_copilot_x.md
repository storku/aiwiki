...
slug: "github_copilot_x"
categories:
  - "Stubs"
  - "Artificial_intelligence_applications"
  - "Software_development_apps"
---*Certain elements of this article are incomplete. You can help the AI Wiki by [**expanding it**](https://aiwiki.ai/index.php?title=GitHub_Copilot_X&action=edit).* 

*See also: [Artificial intelligence applications](/wiki/artificial_intelligence_applications) and [software development apps](/index.php?title=Software_development_apps&action=edit&redlink=1)*
...
GitHub Copilot X is not a separate product offering but a representation of the company's vision for the future of [GitHub Copilot](/wiki/github_copilot). As GitHub designs, tests, and builds features that align with this vision, they are also determining the best way to provide these features to their customers. Specific timelines for the availability of these features are not guaranteed. Developers who are interested in previewing upcoming features can join the waitlist for the specific features they want to explore. Each feature's waitlist is separate, and joining one does not imply interest in multiple features.
...
### [GitHub Copilot Chat](/index.php?title=GitHub_Copilot_Chat&action=edit&redlink=1)
...
### [GitHub Copilot Voice](/index.php?title=GitHub_Copilot_Voice&action=edit&redlink=1)
...
### [Copilot for Pull Requests](/index.php?title=Copilot_for_Pull_Requests&action=edit&redlink=1)
...
### [GitHub Copilot for Docs](/index.php?title=GitHub_Copilot_for_Docs&action=edit&redlink=1)
...
### [Copilot for the Command Line Interface (CLI)](/index.php?title=Copilot_for_the_Command_Line_Interface_(CLI)&action=edit&redlink=1)
