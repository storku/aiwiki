...
| **Developer** | ChatGPT |
| **OpenAI URL** | [https://chat.openai.com//g/g-6PKrcgTBL-planty](https://chat.openai.com//g/g-6PKrcgTBL-planty) |
| **Chats** | 0 |
| **Free** | Yes |
| **Available** | Yes |
| **Working** | Yes |
...
**Planty** is a [Custom GPT](/wiki/custom_gpt) for [ChatGPT](/wiki/chatgpt) in the [GPT Store](/wiki/gpt_store).                        
