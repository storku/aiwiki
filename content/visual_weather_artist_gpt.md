...
slug: "visual_weather_artist_gpt"
categories:
  - "Agents"
  - "Custom_GPTs"
...
| **Developer** | Alex Volkov |
| **OpenAI URL** | [https://chat.openai.com//g/g-twUGxmpHv-visual-weather-artist-gpt](https://chat.openai.com//g/g-twUGxmpHv-visual-weather-artist-gpt) |
| **Chats** | 17,000 |
| **Web Browsing** | Yes |
...
**Visual Weather Artist GPT** is a [Custom GPT](/wiki/custom_gpt) for [ChatGPT](/wiki/chatgpt) in the [GPT Store](/wiki/gpt_store).                        
...
The image should incorporate the weather conditions stylistically, such as having elements in the image reflect the weather (for example text of the temperature that looks wet in rainy conditions). 
